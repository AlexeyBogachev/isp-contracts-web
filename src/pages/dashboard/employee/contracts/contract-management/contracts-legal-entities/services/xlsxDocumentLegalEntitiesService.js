...
export const downloadLegalEntitiesAsExcel = async (contracts) => {
  ...
  const header = [
    ...
    "ФИО директора", "Контактное лицо", "Контактный телефон", "Веб-сайт", "Тариф",
    "Скорость (Мбит/с)", "Статус", "Дата создания заявки", "Лицевой счёт",
    "Сумма", "Дата заключения", "Дата расторжения", "Условия"
  ];
